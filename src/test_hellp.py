...
node1 = node(x=10, y=200, size=20, text=xxx)
node2 = node(x=10, y=225, size=20, text=xxx, face='Consolas-With-Yahei')
node3 = node(x=10, y=250, size=20, text=xxx, face='Source Han Sans HW SC')
